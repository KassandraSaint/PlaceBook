...
class MapsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun bookmarkToBookmarkView(bookmark: Bookmark) = BookmarkView(bookmark.id, LatLng(bookmark.latitude, bookmark.longitude), bookmark.name, bookmark.phone)
